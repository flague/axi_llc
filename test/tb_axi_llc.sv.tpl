...
module tb_axi_llc #(
  ...
  `AXI_ASSIGN_TO_REQ(axi_cpu_req, axi_cpu_intf_dv) // assign all req signals to axi_cpu_req
  `AXI_ASSIGN_FROM_RESP(axi_cpu_intf_dv, axi_cpu_res) // assign all resp signals from axi_cpu_intf_dv

  `AXI_ASSIGN_FROM_REQ(axi_mem_intf_dv, axi_mem_req) // axi_mem_intf_dv = axi_mem_req only req signals
